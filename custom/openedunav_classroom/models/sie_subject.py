...
class SieSubject(models.Model):
    ...
    #     id = self.env.ref('openedunav_core.group_faculty').id
    ...
    senescyt_code = fields.Char(
        'Código SENESCYT',
        size=64,
        search='_search_senescyt_code'
    )
    ...
    unit_ids = fields.One2many(
        ...
        string='Unidades de Aprendizaje',
        required=True
    )
    ...
    subject_type = fields.Selection(
        [
            ('common', 'Asignaturas comunes'),
            ('professional', u'Capacitación Profesional')
        ],
    ...
    subject_content_ids = fields.One2many(
        'sie.subject.content',
        inverse_name='subject_id'
    )
